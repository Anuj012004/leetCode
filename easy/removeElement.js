...
// (nums,num), array -> contains integers, -ve and +ve elements, 
// i have to return the length of the nums after removing the vals
// example : nums = [3,2,2,3] ,vals = 3 => 2
// nums =  [0,1,2,2,3,0,4,2], val = 2 =>  5
// nums = [1,2], vals = 1 => 1

function removeElement(nums,val){
    // let filteredArr =  nums.filter((x)=>x!==val).length
...
console.log(removeElement([1,2], 1)); // Expected output: 1

...
// we have two arrays -> both contains the intergers, length of both equal, 
// we need to place the fruits in the basket from left to right 
// we have to return the number of fruit which remain unplaced in the basket

//example : let the fruits = [1,2,5] and the basket = [2,5,4] => return 1
//let fruits = [4,5,8] and basket = [3,5,8] => return 1
...
console.log(numOfUnplacedFruits([4,2,5],[3,5,4]), 'should be 1')
console.log(numOfUnplacedFruits([3,6,1],[6,4,7]),'should be 0')